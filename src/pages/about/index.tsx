...
const AboutContent = () => {
  return (
    <ContentContainer css={contentContainerStyles}>
      <h1>
        Hi again, I am Abhin – a developer with a passion for crafting intuitive
        digital products through creative problem-solving.
      </h1>
      <h2 id="study">Study</h2>
      <p>
        I completed my undergraduate studies from the University of Delhi,
        completing a Bachelor of Science honours degree in Statistics, from 2019
        to 2022.
      </p>
      <p>
        ...
        courses, YouTube videos, and reading through many Github repositories, I
        developed my skills. In 2021, I formally decided to take up software
        development as a career.
      </p>
      <h2 id="experience">Experience</h2>
      <p>
        The zest to build & create, for me, started as a childish whim, and a
        creative outlet. In 2021, it grew strong enough for me to start working
        as a developer.
      </p>
      <p>
        I developed the first ever online internship portal for my college, and
        I have been enjoying the rail-ride since. I started working as a
        ...
        , I joined them as a Product Engineer in 2022, working with them for an
        year.
      </p>
      <p>
      ...
      <p>
        Currently working part-time as a voluntary frontend developer at ReWorld
        Earth.
      </p>
      <p>
        Find an exhaustive{' '}
      ...
      <p>
        ...
        , I have created a comprehensive guide on collaborating with me, and the
        values I follow.
      </p>
      <p>
        <Link
